...
function aplicacionOCR()
    ...
    %% clasificación KNN
    model = fitcknn(trainset,className); %Enlaza lo del training set con el nombre de la clase
    ...
    segments = segmentosImagen('testSet/text1.png',1);
...
function [label] = predictionGivenImage(model,imgTest)
    instance4test = caracteristicas(imgTest);
